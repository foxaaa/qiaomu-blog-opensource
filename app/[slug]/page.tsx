      ...
      <main className="page-main mx-auto w-full max-w-3xl px-4 sm:px-6 flex-1 py-8 sm:py-12">
        {searchIndexable && (() => {
          ...
          const jsonLd = {
            ...
            description: post.description || '',
            image: ogImage,
            author: { '@type': 'Person', name: '山区来的狐', url: 'https://www.hn-wow.top' },
            publisher: { '@type': 'Organization', name: '笔尖时光', url: baseUrl, logo: { '@type': 'ImageObject', url: `${baseUrl}/icon-512.png` } },
